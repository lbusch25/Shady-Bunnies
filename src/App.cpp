...
//    diffuseRamp = Texture::create2DTextureFromFile("lightingToon.jpg");
    diffuseRamp = Texture::create2DTextureFromFile("lightingFunky.jpg");
...
//    specularRamp = Texture::create2DTextureFromFile("lightingFunky.jpg");
...
//    float specularExponent = 27.9;
    ...
    shader.setUniform("ambientReflection", ambientReflectionCoeff);
    shader.setUniform("diffuseReflection", diffuseReflectionCoeff);
    shader.setUniform("specularReflection", specularReflectionCoeff);
    shader.setUniform("specularExp", specularExponent);
    
    shader.setUniform("ambientIntensity", ambientLightIntensity);
    shader.setUniform("diffuseIntensity", diffuseLightIntensity);
    shader.setUniform("specularIntensity", specularLightIntensity);
